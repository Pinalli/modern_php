...
$string = "Show com o AC/DC foi ótimo";
...
var_dump ([
   ...
   // "mb_substr" => mb_substr($mbReplace, 30),
    "mb_substr" => mb_substr($mbReplace, 30 + 2, 14),
    "mb_strstr" => mb_strstr($mbReplace, ", ", true),
    "mb_strrchr" =>mb_strrchr($mbReplace, ", ", true),
]);

/**
 * [ replace ] https://php.net/manual/en/function.str-replace.php
 */
 
fullStackPHPClassSession("replace", __LINE__);
$mbReplace = $string;
echo "<p>", $string ,"</p>";
//echo "<p>", str_replace("AC/DC", "Iron Maiden",$mbReplace) ,"</p>";
echo "<p>", str_replace(["AC/DC", "com o","ótimo" ], "Iron Maiden",$mbReplace) ,"</p>";
echo "<p>", str_replace(["AC/DC", "ótimo"], ["Iron Maiden", "épico!"],$mbReplace) ,"</p>";
...
$endPoint = "name=Alberto Pinalli&email=betopinalli@email.com";
